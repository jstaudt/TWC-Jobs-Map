...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-19e487ee", module.exports)
  } else {
    hotAPI.update("_v-19e487ee", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":57,"vue-hot-reload-api":55,"vueify/lib/insert-css":58}],60:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n\n")
'use strict';
...
var _mapStyle = require('./mapStyle.vue');
...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            style: _mapStyle2.default.style,
    ...
    methods: {
        processDataSource: function processDataSource() {
            for (var prop in this.fields) {
                ...
                try {
                    for (var _iterator = (0, _getIterator3.default)(this[prop]), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        loadModal: function loadModal(id, isJob) {
            var modal = isJob ? this.modal : this.providerModal;
            var obj = isJob ? this.jobs : this.providers;

            for (var prop in modal) {
        ...
        getJobs: function getJobs(where) {
            ...
            this.$http.post('/index', { where: where, table: "jobs" }).then(function (response) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-9e5fe000", module.exports)
  } else {
    hotAPI.update("_v-9e5fe000", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./mapStyle.vue":61,"babel-runtime/core-js/get-iterator":1,"vue":57,"vue-hot-reload-api":55,"vueify/lib/insert-css":58}],61:[function(require,module,exports){
'use strict';
...
exports.default = {
  style: [{ elementType: 'geometry', stylers: [{ color: '#242f3e' }] }, { elementType: 'labels.text.stroke', stylers: [{ color: '#242f3e' }] }, { elementType: 'labels.text.fill', stylers: [{ color: '#746855' }] }, {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-675194df", module.exports)
  } else {
    hotAPI.update("_v-675194df", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":57,"vue-hot-reload-api":55}],62:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        ...
        getProviders: function getProviders() {
            ...
            var where = { 'facility': this.whereFacility };
            this.$http.post('/index', { where: where, table: "providers" }).then(function (response) {
                _this.providers = response.body.providers;
                _this.geocodes = response.body.geocodes;
                ...
                for (var prop in _this.providers) {
                    if (_this.geocodes.hasOwnProperty(_this.providers[prop].license)) {
                        (function () {
                            var that = _this;
                            var code = _this.geocodes[_this.providers[prop].license];
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"container\">\n    <div class=\"row\">\n        <div>\n            <h1 class=\"mapTitle\">C2 Providers Map</h1>\n        </div>\n\n        <div>\n            <div>\n                <label for=\"facility\">Choose Facility Type</label>\n                <div class=\"select-style\">\n                    <select id=\"facility\" @change=\"getProviders()\" v-model=\"whereFacility\" name=\"facility\">\n                        <option v-for=\"facility in fields.facility\" v-bind:value=\"facility\">\n                          {{facility}}\n                      </option>\n                    </select>\n                </div>\n            </div>\n        </div>\n\n        <div id=\"map\" class=\"\"></div>\n\n        <!-- modal -->\n        <div id=\"modal\" class=\"modal animated fade\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">\n\n          <!-- dialog -->\n            <div class=\"modal-dialog\">\n\n                <!-- content -->\n                <div class=\"modal-content\">\n\n                    <!-- header -->\n                    <div class=\"modal-header\">\n                        <h3 id=\"myModalLabel\" class=\"modal-title\">{{modal.provider_name}}</h3>\n                    </div>\n                    <!-- header -->\n                      \n                    <!-- body -->\n                    <div class=\"modal-body\">\n                        <h5>Address:</h5>\n                        <p>{{modal.address}}</p>\n                        <p><span>{{modal.city}}, </span><span>{{modal.state}} </span><span>{{modal.zip}}</span></p>\n\n                        <h5>Phone Number</h5>\n                        <p>{{modal.phone_number}}</p>\n                    </div>\n                      <!-- body -->\n\n                    <!-- footer -->\n                    <div class=\"modal-footer\">\n                        <button class=\"btn btn-secondary\" data-dismiss=\"modal\">\n                          close\n                        </button>\n                    </div>\n                    <!-- footer -->\n\n                </div>\n                    <!-- content -->\n            </div>\n                <!-- dialog -->\n        </div>\n        <!-- modal -->\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-65816968", module.exports)
  } else {
    hotAPI.update("_v-65816968", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./mapStyle.vue":61,"babel-runtime/core-js/get-iterator":1,"vue":57,"vue-hot-reload-api":55}],63:[function(require,module,exports){
'use strict';

var _jobs = require('./components/jobs.vue');
...
var _providers = require('./components/providers.vue');
...
var jobsApp = window.jobsApp = new Vue({
    ...
    components: { jobs: _jobs2.default, providers: _providers2.default, home: _home2.default },
...
},{"./components/home.vue":59,"./components/jobs.vue":60,"./components/providers.vue":62,"vue":57,"vue-resource":56}]},{},[63]);
